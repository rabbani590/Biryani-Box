...
import { CreditCard, MapPin, CheckCircle, ChevronLeft, Building, Home, ShieldCheck, Printer, Download } from 'lucide-react';
            ...
            {step === 1 ? (
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="bg-secondary/40 p-8 rounded-3xl border border-white/5 space-y-6">
                      ...
                      <div className="space-y-2">
                         <label className="text-[10px] font-bold text-text-muted uppercase tracking-widest px-2">Detailed Instructions</label>
                         <textarea 
              ...
              >
                ...
                <div className="flex flex-col items-center gap-6">
                   ...
                   <p className="text-[10px] text-text-muted italic">Returning you to the home hub in seconds...</p>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
